...
message Samples {
	...
	message ClientSample {
		...
		message PeerConnectionTransport {
			...
			optional string localCertificateId = 11;
			optional int32 packetsReceived = 12;
			optional int32 packetsSent = 13;
			optional string remoteCertificateId = 14;
			optional int32 selectedCandidatePairChanges = 15;
			optional string selectedCandidatePairId = 16;
			optional string srtpCipher = 17;
			optional string tlsGroup = 18;
		...
		message IceCandidatePair {
			...
			optional int64 lastPacketSentTimestamp = 11;
			optional string localCandidateId = 12;
			optional bool nominated = 13;
			optional int32 packetsDiscardedOnSend = 14;
			optional int32 packetsReceived = 15;
			optional int32 packetsSent = 16;
			optional string remoteCandidateId = 17;
			optional int32 requestsReceived = 18;
			optional int32 requestsSent = 19;
			optional int32 responsesReceived = 20;
			optional int32 responsesSent = 21;
			optional string state = 22;
			optional double totalRoundTripTime = 23;
			optional string transportId = 24;
		}
		...
		message InboundVideoTrack {
			...
			optional double framesDropped = 12;
