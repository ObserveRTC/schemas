export const schema = {
  ...
  "fields": [
    ...
    {
      "name": "type",
      "doc": "The type of the meta data. Possible values are: CERTIFICATE, CODEC, ICE_LOCAL_CANDIDATE, ICE_REMOTE_CANDIDATE, ICE_SERVER, MEDIA_CONSTRAINT, MEDIA_DEVICE, MEDIA_SOURCE, USER_MEDIA_ERROR,",
      "type": [
        "null",
        "string"
      ],
