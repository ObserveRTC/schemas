...
// const { W3CStandardStatsIdentifierFetcher } = require('./W3CStandardStatsIdentifierFetcher');
import { ArgumentParser } from 'argparse';
// import { version } from "./package.json";
import { W3CStandardStatsIdentifierFetcher } from './sources/samples/v2/W3CStandardStatsIdentifierFetcher.js';
...
const start = async () => {
    try {
        // const statsIdentifierFetcher = new W3CStandardStatsIdentifierFetcher();
        // await statsIdentifierFetcher.fetch();
        // HERE_I_DIE;
