...
export type SfuSctpChannel = {
	...
	*/
	...
	/**
	* Flag to indicate that the SCTP channel is used as an internal communication between SFU instances
	*/
	internal?: boolean;
...
export type SfuOutboundRtpPad = {
	...
	*/
	...
	/**
	* The bitrate the corresponded stream targets.
	*/
	...
	*/
	...
	/**
	* If rtx packets sent on the same stream then this number indicates how many have been sent
	*/
	rtxPacketsSent?: number;

	/**
	* If rtx packets are received on the same stream then this number indicates how many have been discarded
	*/
	...
	*/
	...
	/**
	* Indicates the number of frames the Sfu has encoded
	*/
	framesEncoded?: number;

	/**
	* Indicates the number of keyframes the Sfu has encoded on the corresponded RTP stream
	*/
...
export type SfuInboundRtpPad = {
	...
	*/
	...
	/**
	* If rtx packets are sent or received on the same stream then this number indicates how many have been sent
	*/
	...
	*/
	...
	/**
	* Indicates the number of frames the Sfu has decoded
	*/
	framesDecoded?: number;

	/**
	* Indicates the number of keyframes the Sfu has decoded
	*/
